 ...
 * @dev Template based on ChunkFactoryFacet - provides hot-swappable factory logic
 * @author PayRox Enhancement Suite
 */
contract {{CONTRACT_NAME}} is IChunkFactory {
    ...
    constructor(address _factoryAddress) {
        require(_factoryAddress != address(0), "{{CONTRACT_NAME}}: Zero address");
        require(_factoryAddress.code.length > 0, "{{CONTRACT_NAME}}: Not a contract");
    ...
    // ═══════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════
    // CUSTOM FUNCTIONS - ADD YOUR CUSTOM LOGIC HERE
    // ═══════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════
