...
USAGE:
  npx ts-node scripts/apply-all-routes-enhanced.ts [OPTIONS]
...
EXAMPLES:
  npx ts-node scripts/apply-all-routes-enhanced.ts --dry-run
  npx ts-node scripts/apply-all-routes-enhanced.ts --verbose --batch-size 5
  npx ts-node scripts/apply-all-routes-enhanced.ts --force
