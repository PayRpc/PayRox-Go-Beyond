...
/**
 * @title InsuranceRewardsFacet
 * @notice Combines insurance policies and reward systems for efficient management
...
contract InsuranceRewardsFacet {
    ...
    bytes32 constant STORAGE_SLOT = keccak256("payrox.facet.insurancerewardsfacet.v1");
    ...
    struct InsuranceRewardsFacetLayout {
    ...
    // Storage accessor
    function _s() internal pure returns (InsuranceRewardsFacetLayout storage layout) {
    ...
    function getInsuranceRewardsFacetVersion() external pure returns (uint8) {
    ...
    function initialize() external onlyDispatcher {
        InsuranceRewardsFacetLayout storage l = _s();
        require(!l.initialized, "InsuranceRewardsFacet: already initialized");
