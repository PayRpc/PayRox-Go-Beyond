...
contract DeFiContractFeeFacetUtilsFacet {
    ...
    function getFacetInfo() external pure returns (string memory) {
        return "DeFiContractFeeFacetUtilsFacet - Universal Generic Integration Facet";
    }
}