...
contract MockFacetUtilsFacetUtilsFacet {
    ...
    function getFacetInfo() external pure returns (string memory) {
        return "MockFacetUtilsFacetUtilsFacet - Universal Generic Integration Facet";
    }
}