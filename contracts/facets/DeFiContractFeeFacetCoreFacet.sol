...
contract DeFiContractFeeFacetCoreFacet {
    ...
    function getFacetInfo() external pure returns (string memory) {
        return "DeFiContractFeeFacetCoreFacet - Universal Generic Integration Facet";
    }
}