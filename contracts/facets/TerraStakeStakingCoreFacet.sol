...
/**
 * @title TerraStakeStakingCoreFacet
 ...
 */
contract TerraStakeStakingCoreFacet {
    // AI-optimized storage layout for Staking
    bytes32 public constant FACET_ID = keccak256("TerraStakeStakingCoreFacet");
    ...
    function getFacetInfo() external pure returns (string memory) {
        return "TerraStakeStakingCoreFacet - Universal Staking Integration Facet";
    }
}