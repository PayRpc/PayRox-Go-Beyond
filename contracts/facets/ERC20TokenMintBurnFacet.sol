...
contract ERC20TokenMintBurnFacet {
    ...
    function getFacetInfo() external pure returns (string memory) {
        return "ERC20TokenMintBurnFacet - Universal Token Integration Facet";
    }
}