...
contract TestOrderedMerkleUtilsFacet {
    ...
    function getFacetInfo() external pure returns (string memory) {
        return "TestOrderedMerkleUtilsFacet - Universal Generic Integration Facet";
    }
}