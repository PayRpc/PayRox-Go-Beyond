...
contract DeFiContractSwapFacetCoreFacet {
    ...
    function getFacetInfo() external pure returns (string memory) {
        return "DeFiContractSwapFacetCoreFacet - Universal Generic Integration Facet";
    }
}