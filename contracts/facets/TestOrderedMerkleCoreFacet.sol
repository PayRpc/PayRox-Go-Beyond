...
contract TestOrderedMerkleCoreFacet {
    ...
    function getFacetInfo() external pure returns (string memory) {
        return "TestOrderedMerkleCoreFacet - Universal Generic Integration Facet";
    }
}