...
/**
 * @title TerraStakeStakingValidatorFacet
 ...
 */
contract TerraStakeStakingValidatorFacet {
    // AI-optimized storage layout for Staking
    bytes32 public constant FACET_ID = keccak256("TerraStakeStakingValidatorFacet");
    ...
    function getFacetInfo() external pure returns (string memory) {
        return "TerraStakeStakingValidatorFacet - Universal Staking Integration Facet";
    }
}