...
contract TokenContractAllowanceFacet {
    ...
    function getFacetInfo() external pure returns (string memory) {
        return "TokenContractAllowanceFacet - Universal Token Integration Facet";
    }
}