...
contract TerraStakeAdminFacetUtilsFacet {
    ...
    function getFacetInfo() external pure returns (string memory) {
        return "TerraStakeAdminFacetUtilsFacet - Universal Generic Integration Facet";
    }
}