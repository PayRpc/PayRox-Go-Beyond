...
contract PingFacetCoreFacet {
    ...
    function getFacetInfo() external pure returns (string memory) {
        return "PingFacetCoreFacet - Universal Generic Integration Facet";
    }
}