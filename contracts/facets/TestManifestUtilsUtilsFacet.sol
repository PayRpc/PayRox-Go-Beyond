...
contract TestManifestUtilsUtilsFacet {
    ...
    function getFacetInfo() external pure returns (string memory) {
        return "TestManifestUtilsUtilsFacet - Universal Generic Integration Facet";
    }
}