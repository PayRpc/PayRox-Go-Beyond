...
contract TokenContractMintBurnFacet {
    ...
    function getFacetInfo() external pure returns (string memory) {
        return "TokenContractMintBurnFacet - Universal Token Integration Facet";
    }
}