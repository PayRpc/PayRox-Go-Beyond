...
/**
 * @title TerraStakeStakingRewardsFacet
 ...
 */
contract TerraStakeStakingRewardsFacet {
    // AI-optimized storage layout for Staking
    bytes32 public constant FACET_ID = keccak256("TerraStakeStakingRewardsFacet");
    ...
    function getFacetInfo() external pure returns (string memory) {
        return "TerraStakeStakingRewardsFacet - Universal Staking Integration Facet";
    }
}