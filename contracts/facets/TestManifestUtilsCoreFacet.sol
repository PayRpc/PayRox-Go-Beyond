...
contract TestManifestUtilsCoreFacet {
    ...
    function getFacetInfo() external pure returns (string memory) {
        return "TestManifestUtilsCoreFacet - Universal Generic Integration Facet";
    }
}