...
contract TerraStakeCoreFacetCoreFacet {
    ...
    function getFacetInfo() external pure returns (string memory) {
        return "TerraStakeCoreFacetCoreFacet - Universal Generic Integration Facet";
    }
}