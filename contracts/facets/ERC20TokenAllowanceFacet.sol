...
contract ERC20TokenAllowanceFacet {
    ...
    function getFacetInfo() external pure returns (string memory) {
        return "ERC20TokenAllowanceFacet - Universal Token Integration Facet";
    }
}