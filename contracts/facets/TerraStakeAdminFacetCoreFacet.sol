...
contract TerraStakeAdminFacetCoreFacet {
    ...
    function getFacetInfo() external pure returns (string memory) {
        return "TerraStakeAdminFacetCoreFacet - Universal Generic Integration Facet";
    }
}