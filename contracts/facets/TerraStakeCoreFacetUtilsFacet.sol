...
contract TerraStakeCoreFacetUtilsFacet {
    ...
    function getFacetInfo() external pure returns (string memory) {
        return "TerraStakeCoreFacetUtilsFacet - Universal Generic Integration Facet";
    }
}