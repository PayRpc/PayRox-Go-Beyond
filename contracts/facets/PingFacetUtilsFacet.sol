...
contract PingFacetUtilsFacet {
    ...
    function getFacetInfo() external pure returns (string memory) {
        return "PingFacetUtilsFacet - Universal Generic Integration Facet";
    }
}