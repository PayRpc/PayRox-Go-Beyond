...
contract MockFacetUtilsFacetCoreFacet {
    ...
    function getFacetInfo() external pure returns (string memory) {
        return "MockFacetUtilsFacetCoreFacet - Universal Generic Integration Facet";
    }
}