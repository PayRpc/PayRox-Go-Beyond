...
contract MockFacetCoreFacetCoreFacet {
    ...
    function getFacetInfo() external pure returns (string memory) {
        return "MockFacetCoreFacetCoreFacet - Universal Generic Integration Facet";
    }
}