...
contract ExampleFacetAUtilsFacet {
    ...
    function getFacetInfo() external pure returns (string memory) {
        return "ExampleFacetAUtilsFacet - Universal Generic Integration Facet";
    }
}