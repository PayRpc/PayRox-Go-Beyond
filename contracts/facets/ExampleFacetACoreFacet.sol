...
contract ExampleFacetACoreFacet {
    ...
    function getFacetInfo() external pure returns (string memory) {
        return "ExampleFacetACoreFacet - Universal Generic Integration Facet";
    }
}