...
contract TokenContractTransferFacet {
    ...
    function getFacetInfo() external pure returns (string memory) {
        return "TokenContractTransferFacet - Universal Token Integration Facet";
    }
}