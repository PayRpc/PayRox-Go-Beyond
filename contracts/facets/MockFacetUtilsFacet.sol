...
contract MockFacetUtilsFacet {
    ...
    function getFacetInfo() external pure returns (string memory) {
        return "MockFacetUtilsFacet - Universal Generic Integration Facet";
    }
}