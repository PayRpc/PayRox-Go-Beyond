...
contract MockFacetCoreFacetUtilsFacet {
    ...
    function getFacetInfo() external pure returns (string memory) {
        return "MockFacetCoreFacetUtilsFacet - Universal Generic Integration Facet";
    }
}