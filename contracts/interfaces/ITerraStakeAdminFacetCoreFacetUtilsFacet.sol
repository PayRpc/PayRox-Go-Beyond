...
/**
 * @title ITerraStakeAdminFacetCoreFacetUtilsFacet
...
interface ITerraStakeAdminFacetCoreFacetUtilsFacet {
...
// Interface Functions
function facetHealthCheck() external pure returns (bool param48bjb67s0);
