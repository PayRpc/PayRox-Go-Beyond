...
/**
 * @title ITerraStakeGovernanceFacetCoreFacetUtilsFacet
...
interface ITerraStakeGovernanceFacetCoreFacetUtilsFacet {
...
// Interface Functions
function facetHealthCheck() external pure returns (bool parammtx8rlkcd);
