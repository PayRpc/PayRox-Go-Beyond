...
/**
 * @title ITerraStakeRewardsFacetUtilsFacetUtilsFacet
...
interface ITerraStakeRewardsFacetUtilsFacetUtilsFacet {
...
// Interface Functions
function facetHealthCheck() external pure returns (bool paramn5pt3vr6p);
