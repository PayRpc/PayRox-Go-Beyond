...
/**
 * @title ITerraStakeValidatorFacetUtilsFacetUtilsFacet
...
interface ITerraStakeValidatorFacetUtilsFacetUtilsFacet {
...
// Interface Functions
function facetHealthCheck() external pure returns (bool paramxvrcehcdy);
