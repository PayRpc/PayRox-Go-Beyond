...
/**
 * @title IDeFiContractLiquidityFacetCoreFacet
...
interface IDeFiContractLiquidityFacetCoreFacet {
...
// Interface Functions
function facetHealthCheck() external pure returns (bool param6siefrdwp);
