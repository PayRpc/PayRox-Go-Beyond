...
/**
 * @title ITerraStakeGovernanceFacetCoreFacetCoreFacet
...
interface ITerraStakeGovernanceFacetCoreFacetCoreFacet {
...
// Interface Functions
function facetHealthCheck() external pure returns (bool param3a97snimi);
