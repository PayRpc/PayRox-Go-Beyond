...
/**
 * @title IGovernanceContractProposalFacetCoreFacet
...
interface IGovernanceContractProposalFacetCoreFacet {
...
// Interface Functions
function facetHealthCheck() external pure returns (bool paramviekpxf51);
