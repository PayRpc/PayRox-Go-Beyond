...
/**
 * @title ITokenContractAllowanceFacetUtilsFacet
...
interface ITokenContractAllowanceFacetUtilsFacet {
...
// Interface Functions
function facetHealthCheck() external pure returns (bool paramc4a3pugqe);
