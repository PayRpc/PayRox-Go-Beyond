...
/**
 * @title ITerraStakeTokenAdminFacet
...
interface ITerraStakeTokenAdminFacet {
...
function getFacetInfo() external pure returns (string memory);
    ...
    function communicateWithFacet(address target, bytes calldata) external returns (bool paramdhag04jm0);
    function facetHealthCheck() external pure returns (bool paramliy98zrkn);
}
