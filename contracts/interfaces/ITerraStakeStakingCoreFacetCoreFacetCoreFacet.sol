...
/**
 * @title ITerraStakeStakingCoreFacetCoreFacetCoreFacet
...
interface ITerraStakeStakingCoreFacetCoreFacetCoreFacet {
...
// Interface Functions
function facetHealthCheck() external pure returns (bool param7lpz1mlwu);
