...
/**
 * @title ITestReentrancyAttackerCoreFacetUtilsFacet
...
interface ITestReentrancyAttackerCoreFacetUtilsFacet {
...
// Interface Functions
function facetHealthCheck() external pure returns (bool param4eev0kk9s);
