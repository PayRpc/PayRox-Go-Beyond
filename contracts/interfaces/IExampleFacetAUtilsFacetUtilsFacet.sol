...
/**
 * @title IExampleFacetAUtilsFacetUtilsFacet
...
interface IExampleFacetAUtilsFacetUtilsFacet {
...
// Interface Functions
function facetHealthCheck() external pure returns (bool parame0o2usbjm);
