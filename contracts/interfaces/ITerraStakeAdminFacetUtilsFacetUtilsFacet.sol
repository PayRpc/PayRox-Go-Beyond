...
/**
 * @title ITerraStakeAdminFacetUtilsFacetUtilsFacet
...
interface ITerraStakeAdminFacetUtilsFacetUtilsFacet {
...
// Interface Functions
function facetHealthCheck() external pure returns (bool paraml399pgkxi);
