...
/**
 * @title ITerraStakeTokenLiquidityFacet
...
interface ITerraStakeTokenLiquidityFacet {
...
function getFacetInfo() external pure returns (string memory);
    ...
    function communicateWithFacet(address target, bytes calldata) external returns (bool parambldh4qgeh);
    function facetHealthCheck() external pure returns (bool paramu0a7w1lyl);
}
