...
/**
 * @title ITerraStakeStakingCoreFacetUtilsFacetUtilsFacet
...
interface ITerraStakeStakingCoreFacetUtilsFacetUtilsFacet {
...
// Interface Functions
function facetHealthCheck() external pure returns (bool parambzjbfxjqg);
