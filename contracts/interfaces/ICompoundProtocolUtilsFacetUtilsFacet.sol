...
/**
 * @title ICompoundProtocolUtilsFacetUtilsFacet
...
interface ICompoundProtocolUtilsFacetUtilsFacet {
...
// Interface Functions
function facetHealthCheck() external pure returns (bool paramlpvmsc2n3);
