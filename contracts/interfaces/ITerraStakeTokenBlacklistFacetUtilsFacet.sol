...
/**
 * @title ITerraStakeTokenBlacklistFacetUtilsFacet
...
interface ITerraStakeTokenBlacklistFacetUtilsFacet {
...
// Interface Functions
function facetHealthCheck() external pure returns (bool paramopdfcvphp);
