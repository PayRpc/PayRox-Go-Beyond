...
/**
 * @title ITerraStakeCoreFacetCoreFacetCoreFacet
...
interface ITerraStakeCoreFacetCoreFacetCoreFacet {
...
// Interface Functions
function facetHealthCheck() external pure returns (bool paramm02aeo6ox);
