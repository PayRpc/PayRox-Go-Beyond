...
/**
 * @title ITerraStakeStakingValidatorFacetCoreFacet
...
interface ITerraStakeStakingValidatorFacetCoreFacet {
...
// Interface Functions
function facetHealthCheck() external pure returns (bool param22s8xzb78);
