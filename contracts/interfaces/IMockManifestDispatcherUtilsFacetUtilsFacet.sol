...
/**
 * @title IMockManifestDispatcherUtilsFacetUtilsFacet
...
interface IMockManifestDispatcherUtilsFacetUtilsFacet {
...
// Interface Functions
function facetHealthCheck() external pure returns (bool paramyvls43xca);
