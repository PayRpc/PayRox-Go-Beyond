...
/**
 * @title IGovernanceContractVotingFacetUtilsFacet
...
interface IGovernanceContractVotingFacetUtilsFacet {
...
// Interface Functions
function facetHealthCheck() external pure returns (bool parami79cy1gnb);
