...
/**
 * @title IStakingContractRewardsFacetCoreFacet
...
interface IStakingContractRewardsFacetCoreFacet {
...
// Interface Functions
function facetHealthCheck() external pure returns (bool param52q8uypk7);
