...
/**
 * @title ITerraStakeTokenLiquidityFacetUtilsFacet
...
interface ITerraStakeTokenLiquidityFacetUtilsFacet {
...
// Interface Functions
function facetHealthCheck() external pure returns (bool param5f9i96dun);
