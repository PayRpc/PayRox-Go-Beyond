...
/**
 * @title ITerraStakeGovernanceFacetUtilsFacetCoreFacet
...
interface ITerraStakeGovernanceFacetUtilsFacetCoreFacet {
...
// Interface Functions
function facetHealthCheck() external pure returns (bool paramfr5bbno9b);
