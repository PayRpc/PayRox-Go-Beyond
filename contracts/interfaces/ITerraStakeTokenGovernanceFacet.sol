...
/**
 * @title ITerraStakeTokenGovernanceFacet
...
interface ITerraStakeTokenGovernanceFacet {
...
function getFacetInfo() external pure returns (string memory);
    ...
    function communicateWithFacet(address target, bytes calldata) external returns (bool paramllfhrbxe9);
    function facetHealthCheck() external pure returns (bool param6ky36f3rj);
}
