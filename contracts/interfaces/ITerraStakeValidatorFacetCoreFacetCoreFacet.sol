...
/**
 * @title ITerraStakeValidatorFacetCoreFacetCoreFacet
...
interface ITerraStakeValidatorFacetCoreFacetCoreFacet {
...
// Interface Functions
function facetHealthCheck() external pure returns (bool param9b4acj87d);
