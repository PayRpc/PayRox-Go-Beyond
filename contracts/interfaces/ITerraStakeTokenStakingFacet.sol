...
/**
 * @title ITerraStakeTokenStakingFacet
...
interface ITerraStakeTokenStakingFacet {
...
function getFacetInfo() external pure returns (string memory);
    ...
    function communicateWithFacet(address target, bytes calldata) external returns (bool paramzcskq74fk);
    function facetHealthCheck() external pure returns (bool param6dcbiqxsc);
}
