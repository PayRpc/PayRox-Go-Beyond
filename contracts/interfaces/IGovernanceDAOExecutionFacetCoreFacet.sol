...
/**
 * @title IGovernanceDAOExecutionFacetCoreFacet
...
interface IGovernanceDAOExecutionFacetCoreFacet {
...
// Interface Functions
function facetHealthCheck() external pure returns (bool paramh1gjoiujt);
