...
/**
 * @title IGovernanceDAOProposalFacetCoreFacet
...
interface IGovernanceDAOProposalFacetCoreFacet {
...
// Interface Functions
function facetHealthCheck() external pure returns (bool param0os86488v);
