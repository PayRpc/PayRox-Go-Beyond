...
/**
 * @title ITerraStakeTokenGovernanceFacetUtilsFacet
...
interface ITerraStakeTokenGovernanceFacetUtilsFacet {
...
// Interface Functions
function facetHealthCheck() external pure returns (bool paramwoavot4g0);
