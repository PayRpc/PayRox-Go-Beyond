...
/**
 * @title ITerraStakeRewardsFacetCoreFacetUtilsFacet
...
interface ITerraStakeRewardsFacetCoreFacetUtilsFacet {
...
// Interface Functions
function facetHealthCheck() external pure returns (bool paramaoa7kdp8t);
