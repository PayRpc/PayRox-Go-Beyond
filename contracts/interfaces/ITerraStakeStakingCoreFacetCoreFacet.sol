...
/**
 * @title ITerraStakeStakingCoreFacetCoreFacet
...
interface ITerraStakeStakingCoreFacetCoreFacet {
...
// Interface Functions
function facetHealthCheck() external pure returns (bool paramkp9h3qpcm);
