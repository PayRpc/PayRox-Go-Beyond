...
/**
 * @title IGovernanceContractExecutionFacetCoreFacet
...
interface IGovernanceContractExecutionFacetCoreFacet {
...
// Interface Functions
function facetHealthCheck() external pure returns (bool param1um464g6b);
