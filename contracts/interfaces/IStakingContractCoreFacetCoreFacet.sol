...
/**
 * @title IStakingContractCoreFacetCoreFacet
...
interface IStakingContractCoreFacetCoreFacet {
...
// Interface Functions
function facetHealthCheck() external pure returns (bool paramq2812be8q);
