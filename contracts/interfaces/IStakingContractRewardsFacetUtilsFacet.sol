...
/**
 * @title IStakingContractRewardsFacetUtilsFacet
...
interface IStakingContractRewardsFacetUtilsFacet {
...
// Interface Functions
function facetHealthCheck() external pure returns (bool param2ugxx53ca);
