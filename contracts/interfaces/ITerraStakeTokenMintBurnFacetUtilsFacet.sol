...
/**
 * @title ITerraStakeTokenMintBurnFacetUtilsFacet
...
interface ITerraStakeTokenMintBurnFacetUtilsFacet {
...
// Interface Functions
function facetHealthCheck() external pure returns (bool paramm5exqv306);
