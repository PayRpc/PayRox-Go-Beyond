...
/**
 * @title ITerraStakeTokenEmergencyFacetCoreFacet
...
interface ITerraStakeTokenEmergencyFacetCoreFacet {
...
// Interface Functions
function facetHealthCheck() external pure returns (bool param7onfvygrl);
