...
/**
 * @title ITestReentrancyAttackerUtilsFacetUtilsFacet
...
interface ITestReentrancyAttackerUtilsFacetUtilsFacet {
...
// Interface Functions
function facetHealthCheck() external pure returns (bool paramj90wr21nb);
