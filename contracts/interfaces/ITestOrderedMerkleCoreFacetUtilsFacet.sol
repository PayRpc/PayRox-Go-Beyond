...
/**
 * @title ITestOrderedMerkleCoreFacetUtilsFacet
...
interface ITestOrderedMerkleCoreFacetUtilsFacet {
...
// Interface Functions
function facetHealthCheck() external pure returns (bool param47vcshnub);
