...
/**
 * @title IStakingContractValidatorFacetCoreFacet
...
interface IStakingContractValidatorFacetCoreFacet {
...
// Interface Functions
function facetHealthCheck() external pure returns (bool parami8xn6b58r);
