...
/**
 * @title ITerraStakeCoreFacetUtilsFacetCoreFacet
...
interface ITerraStakeCoreFacetUtilsFacetCoreFacet {
...
// Interface Functions
function facetHealthCheck() external pure returns (bool param96s2wk19t);
