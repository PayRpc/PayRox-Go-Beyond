...
/**
 * @title IGovernanceDAOExecutionFacetUtilsFacet
...
interface IGovernanceDAOExecutionFacetUtilsFacet {
...
// Interface Functions
function facetHealthCheck() external pure returns (bool paramdhw8dtg74);
