...
/**
 * @title ICompoundProtocolCoreFacetCoreFacet
...
interface ICompoundProtocolCoreFacetCoreFacet {
...
// Interface Functions
function facetHealthCheck() external pure returns (bool parambka4fp6q7);
