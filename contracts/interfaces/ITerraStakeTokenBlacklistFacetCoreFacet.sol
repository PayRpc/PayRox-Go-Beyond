...
/**
 * @title ITerraStakeTokenBlacklistFacetCoreFacet
...
interface ITerraStakeTokenBlacklistFacetCoreFacet {
...
// Interface Functions
function facetHealthCheck() external pure returns (bool param208pxr5g7);
