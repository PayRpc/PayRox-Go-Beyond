...
/**
 * @title ITokenContractTransferFacetCoreFacet
...
interface ITokenContractTransferFacetCoreFacet {
...
// Interface Functions
function facetHealthCheck() external pure returns (bool paramelnoh3ve3);
