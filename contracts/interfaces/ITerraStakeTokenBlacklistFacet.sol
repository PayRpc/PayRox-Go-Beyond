...
/**
 * @title ITerraStakeTokenBlacklistFacet
...
interface ITerraStakeTokenBlacklistFacet {
...
function getFacetInfo() external pure returns (string memory);
    ...
    function communicateWithFacet(address target, bytes calldata) external returns (bool paramlbbn1evh2);
    function facetHealthCheck() external pure returns (bool paramtuzpk3iew);
}
