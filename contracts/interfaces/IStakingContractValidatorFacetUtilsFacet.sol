...
/**
 * @title IStakingContractValidatorFacetUtilsFacet
...
interface IStakingContractValidatorFacetUtilsFacet {
...
// Interface Functions
function facetHealthCheck() external pure returns (bool parameug8tcwoh);
