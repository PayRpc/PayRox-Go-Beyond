...
/**
 * @title ITerraStakeTokenMintBurnFacetCoreFacet
...
interface ITerraStakeTokenMintBurnFacetCoreFacet {
...
// Interface Functions
function facetHealthCheck() external pure returns (bool param0ins6xq18);
