...
/**
 * @title ITerraStakeTokenTWAPFacet
...
interface ITerraStakeTokenTWAPFacet {
...
function getFacetInfo() external pure returns (string memory);
    ...
    function communicateWithFacet(address target, bytes calldata) external returns (bool param5ucmxybex);
    function facetHealthCheck() external pure returns (bool param1luh8vox4);
}
