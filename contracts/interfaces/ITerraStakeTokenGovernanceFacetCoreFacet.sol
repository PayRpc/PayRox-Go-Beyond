...
/**
 * @title ITerraStakeTokenGovernanceFacetCoreFacet
...
interface ITerraStakeTokenGovernanceFacetCoreFacet {
...
// Interface Functions
function facetHealthCheck() external pure returns (bool paramdut6gxtzr);
