...
/**
 * @title ITestManifestUtilsCoreFacetCoreFacet
...
interface ITestManifestUtilsCoreFacetCoreFacet {
...
// Interface Functions
function facetHealthCheck() external pure returns (bool parammchhelezq);
