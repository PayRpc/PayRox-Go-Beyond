...
/**
 * @title ITerraStakeCoreFacetUtilsFacetUtilsFacet
...
interface ITerraStakeCoreFacetUtilsFacetUtilsFacet {
...
// Interface Functions
function facetHealthCheck() external pure returns (bool paramyf9szilf6);
