...
/**
 * @title ITerraStakeTokenEmergencyFacet
...
interface ITerraStakeTokenEmergencyFacet {
...
function getFacetInfo() external pure returns (string memory);
    ...
    function communicateWithFacet(address target, bytes calldata) external returns (bool paramyk65k1lr8);
    function facetHealthCheck() external pure returns (bool param3lt1lsctk);
}
