...
/**
 * @title ITestReentrancyAttackerCoreFacetCoreFacet
...
interface ITestReentrancyAttackerCoreFacetCoreFacet {
...
// Interface Functions
function facetHealthCheck() external pure returns (bool paramezfeax6fp);
