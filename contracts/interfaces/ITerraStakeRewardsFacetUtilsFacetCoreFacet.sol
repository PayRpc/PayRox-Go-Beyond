...
/**
 * @title ITerraStakeRewardsFacetUtilsFacetCoreFacet
...
interface ITerraStakeRewardsFacetUtilsFacetCoreFacet {
...
// Interface Functions
function facetHealthCheck() external pure returns (bool paramzwc1r89je);
