...
/**
 * @title ITerraStakeStakingGovernanceFacetCoreFacet
...
interface ITerraStakeStakingGovernanceFacetCoreFacet {
...
// Interface Functions
function facetHealthCheck() external pure returns (bool param71nj6elgb);
