...
/**
 * @title IGovernanceContractProposalFacetUtilsFacet
...
interface IGovernanceContractProposalFacetUtilsFacet {
...
// Interface Functions
function facetHealthCheck() external pure returns (bool param9o8zvmr88);
