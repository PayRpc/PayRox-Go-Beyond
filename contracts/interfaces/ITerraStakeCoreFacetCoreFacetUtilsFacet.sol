...
/**
 * @title ITerraStakeCoreFacetCoreFacetUtilsFacet
...
interface ITerraStakeCoreFacetCoreFacetUtilsFacet {
...
// Interface Functions
function facetHealthCheck() external pure returns (bool param21oya0gte);
