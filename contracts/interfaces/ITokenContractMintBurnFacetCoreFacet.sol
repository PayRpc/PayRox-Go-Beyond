...
/**
 * @title ITokenContractMintBurnFacetCoreFacet
...
interface ITokenContractMintBurnFacetCoreFacet {
...
// Interface Functions
function facetHealthCheck() external pure returns (bool paramcnatr20wl);
