...
/**
 * @title ITerraStakeStakingRewardsFacetUtilsFacet
...
interface ITerraStakeStakingRewardsFacetUtilsFacet {
...
// Interface Functions
function facetHealthCheck() external pure returns (bool paramk6zqaowtv);
