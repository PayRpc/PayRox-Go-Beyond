...
/**
 * @title ITerraStakeGovernanceFacetUtilsFacetUtilsFacet
...
interface ITerraStakeGovernanceFacetUtilsFacetUtilsFacet {
...
// Interface Functions
function facetHealthCheck() external pure returns (bool param2h8w8vqwg);
