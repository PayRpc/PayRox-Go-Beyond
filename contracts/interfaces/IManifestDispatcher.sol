...
interface IManifestDispatcher is IAccessControl {
    ...
    // Additional events for governance and routing
    event GovernanceRotationQueued(address indexed newGovernance, uint64 eta);
    ...
    event ManifestVersionUpdated(uint256 oldVersion, uint256 newVersion);
    event ManifestApplied(bytes32 indexed manifestHash, uint256 entryCount);
