...
/**
 * @title IMockManifestDispatcherCoreFacetUtilsFacet
...
interface IMockManifestDispatcherCoreFacetUtilsFacet {
...
// Interface Functions
function facetHealthCheck() external pure returns (bool param9lwgltycl);
