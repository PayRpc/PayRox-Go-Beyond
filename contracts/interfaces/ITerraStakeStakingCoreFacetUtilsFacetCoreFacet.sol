...
/**
 * @title ITerraStakeStakingCoreFacetUtilsFacetCoreFacet
...
interface ITerraStakeStakingCoreFacetUtilsFacetCoreFacet {
...
// Interface Functions
function facetHealthCheck() external pure returns (bool param29xzwl1tq);
