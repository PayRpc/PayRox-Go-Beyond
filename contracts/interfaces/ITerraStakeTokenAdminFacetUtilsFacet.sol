...
/**
 * @title ITerraStakeTokenAdminFacetUtilsFacet
...
interface ITerraStakeTokenAdminFacetUtilsFacet {
...
// Interface Functions
function facetHealthCheck() external pure returns (bool paramr9nv7l9jn);
