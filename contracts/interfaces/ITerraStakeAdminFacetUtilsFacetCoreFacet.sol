...
/**
 * @title ITerraStakeAdminFacetUtilsFacetCoreFacet
...
interface ITerraStakeAdminFacetUtilsFacetCoreFacet {
...
// Interface Functions
function facetHealthCheck() external pure returns (bool paramgymwrg6yp);
