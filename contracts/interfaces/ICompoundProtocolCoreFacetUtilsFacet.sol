...
/**
 * @title ICompoundProtocolCoreFacetUtilsFacet
...
interface ICompoundProtocolCoreFacetUtilsFacet {
...
// Interface Functions
function facetHealthCheck() external pure returns (bool paramb5v0np5n7);
