...
/**
 * @title ICompoundProtocolUtilsFacetCoreFacet
...
interface ICompoundProtocolUtilsFacetCoreFacet {
...
// Interface Functions
function facetHealthCheck() external pure returns (bool paramywr3hd024);
