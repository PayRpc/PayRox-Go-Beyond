...
/**
 * @title ITerraStakeStakingGovernanceFacetUtilsFacet
...
interface ITerraStakeStakingGovernanceFacetUtilsFacet {
...
// Interface Functions
function facetHealthCheck() external pure returns (bool paramg16hsuel1);
