...
/**
 * @title IStakingContractGovernanceFacetCoreFacet
...
interface IStakingContractGovernanceFacetCoreFacet {
...
// Interface Functions
function facetHealthCheck() external pure returns (bool paramg3mraarhm);
