...
/**
 * @title ITerraStakeAdminFacetCoreFacetCoreFacet
...
interface ITerraStakeAdminFacetCoreFacetCoreFacet {
...
// Interface Functions
function facetHealthCheck() external pure returns (bool parampb3fnzo33);
