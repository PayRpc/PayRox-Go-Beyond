...
/**
 * @title ITerraStakeValidatorFacetCoreFacet
...
interface ITerraStakeValidatorFacetCoreFacet {
...
// Interface Functions
function facetHealthCheck() external pure returns (bool paramfdfadv4mb);
