...
/**
 * @title IGovernanceDAOProposalFacetUtilsFacet
...
interface IGovernanceDAOProposalFacetUtilsFacet {
...
// Interface Functions
function facetHealthCheck() external pure returns (bool param7s86fg4lt);
