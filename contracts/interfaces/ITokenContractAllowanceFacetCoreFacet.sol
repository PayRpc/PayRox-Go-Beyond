...
/**
 * @title ITokenContractAllowanceFacetCoreFacet
...
interface ITokenContractAllowanceFacetCoreFacet {
...
// Interface Functions
function facetHealthCheck() external pure returns (bool param9i3kfjjvp);
