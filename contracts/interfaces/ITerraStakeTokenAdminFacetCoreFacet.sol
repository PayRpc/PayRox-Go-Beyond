...
/**
 * @title ITerraStakeTokenAdminFacetCoreFacet
...
interface ITerraStakeTokenAdminFacetCoreFacet {
...
// Interface Functions
function facetHealthCheck() external pure returns (bool parammi4dy6iyx);
