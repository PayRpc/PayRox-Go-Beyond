...
/**
 * @title ITerraStakeStakingValidatorFacetUtilsFacet
...
interface ITerraStakeStakingValidatorFacetUtilsFacet {
...
// Interface Functions
function facetHealthCheck() external pure returns (bool paramsgwb3nawp);
