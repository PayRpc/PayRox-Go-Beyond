...
/**
 * @title ITestManifestUtilsUtilsFacetCoreFacet
...
interface ITestManifestUtilsUtilsFacetCoreFacet {
...
// Interface Functions
function facetHealthCheck() external pure returns (bool param2c8kxr5lu);
