...
/**
 * @title IMockManifestDispatcherUtilsFacetCoreFacet
...
interface IMockManifestDispatcherUtilsFacetCoreFacet {
...
// Interface Functions
function facetHealthCheck() external pure returns (bool param7x7movk54);
