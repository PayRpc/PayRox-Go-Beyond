...
/**
 * @title ITokenContractTransferFacetUtilsFacet
...
interface ITokenContractTransferFacetUtilsFacet {
...
// Interface Functions
function facetHealthCheck() external pure returns (bool paramj9h2wnzx5);
