...
/**
 * @title IGovernanceContractExecutionFacetUtilsFacet
...
interface IGovernanceContractExecutionFacetUtilsFacet {
...
// Interface Functions
function facetHealthCheck() external pure returns (bool paramidc6rc41o);
