...
/**
 * @title IStakingContractGovernanceFacetUtilsFacet
...
interface IStakingContractGovernanceFacetUtilsFacet {
...
// Interface Functions
function facetHealthCheck() external pure returns (bool paramrol8h8f99);
