...
/**
 * @title IGovernanceDAOVotingFacetCoreFacet
...
interface IGovernanceDAOVotingFacetCoreFacet {
...
// Interface Functions
function facetHealthCheck() external pure returns (bool param4rxgch74y);
