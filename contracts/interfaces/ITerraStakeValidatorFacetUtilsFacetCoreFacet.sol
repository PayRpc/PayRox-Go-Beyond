...
/**
 * @title ITerraStakeValidatorFacetUtilsFacetCoreFacet
...
interface ITerraStakeValidatorFacetUtilsFacetCoreFacet {
...
// Interface Functions
function facetHealthCheck() external pure returns (bool paramdwtbcwyxi);
