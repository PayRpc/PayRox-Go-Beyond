...
/**
 * @title IGovernanceDAOVotingFacetUtilsFacet
...
interface IGovernanceDAOVotingFacetUtilsFacet {
...
// Interface Functions
function facetHealthCheck() external pure returns (bool param1nwbldoky);
