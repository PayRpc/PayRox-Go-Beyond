...
/**
 * @title IGovernanceContractVotingFacetCoreFacet
...
interface IGovernanceContractVotingFacetCoreFacet {
...
// Interface Functions
function facetHealthCheck() external pure returns (bool paramjkkvklhf3);
