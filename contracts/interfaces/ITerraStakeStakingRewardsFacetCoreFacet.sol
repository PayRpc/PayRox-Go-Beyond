...
/**
 * @title ITerraStakeStakingRewardsFacetCoreFacet
...
interface ITerraStakeStakingRewardsFacetCoreFacet {
...
// Interface Functions
function facetHealthCheck() external pure returns (bool paramfr78t0qr8);
