...
/**
 * @title ITerraStakeTokenCoreFacet
...
interface ITerraStakeTokenCoreFacet {
...
function getFacetInfo() external pure returns (string memory);
    ...
    function communicateWithFacet(address target, bytes calldata) external returns (bool paramy00gdgs17);
    function facetHealthCheck() external pure returns (bool paramuzbzek0bs);
}
