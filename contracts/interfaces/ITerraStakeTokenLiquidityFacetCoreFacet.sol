...
/**
 * @title ITerraStakeTokenLiquidityFacetCoreFacet
...
interface ITerraStakeTokenLiquidityFacetCoreFacet {
...
// Interface Functions
function facetHealthCheck() external pure returns (bool param3lphxuth5);
