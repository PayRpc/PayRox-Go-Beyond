...
/**
 * @title ITestReentrancyAttackerUtilsFacetCoreFacet
...
interface ITestReentrancyAttackerUtilsFacetCoreFacet {
...
// Interface Functions
function facetHealthCheck() external pure returns (bool paramspusb4wg1);
