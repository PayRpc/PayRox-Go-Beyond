...
/**
 * @title IStakingContractCoreFacetUtilsFacet
...
interface IStakingContractCoreFacetUtilsFacet {
...
// Interface Functions
function facetHealthCheck() external pure returns (bool paramq36diw47n);
