...
/**
 * @title IMockManifestDispatcherCoreFacetCoreFacet
...
interface IMockManifestDispatcherCoreFacetCoreFacet {
...
// Interface Functions
function facetHealthCheck() external pure returns (bool param0quxgug6a);
