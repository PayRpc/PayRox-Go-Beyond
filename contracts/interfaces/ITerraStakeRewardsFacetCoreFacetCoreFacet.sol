...
/**
 * @title ITerraStakeRewardsFacetCoreFacetCoreFacet
...
interface ITerraStakeRewardsFacetCoreFacetCoreFacet {
...
// Interface Functions
function facetHealthCheck() external pure returns (bool paramea26esd1s);
