...
/**
 * @title ITokenContractMintBurnFacetUtilsFacet
...
interface ITokenContractMintBurnFacetUtilsFacet {
...
// Interface Functions
function facetHealthCheck() external pure returns (bool paramncr780n5e);
